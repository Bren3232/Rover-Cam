...
b = open("/home/pi/Desktop/Rover_Cam/comm2.txt", "r")
back_to = b.read()
b.close()
...
#         print(prog)
        ...
        f = open(path_usb + "/RC_config.txt", "w")
        f.truncate(0)
        for i in prog:
            f.write(i + "\n")
        f.close()
...
#             print("launch file in selectm-mode.py------------")
            ...
            run(['python3', f'/home/pi/Desktop/Rover_Cam/disable.py'])


modes = run(["ls", "/home/pi/Desktop/Rover_Cam/modes"], capture_output=True).stdout
